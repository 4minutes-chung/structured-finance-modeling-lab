...
5) computes an excellence scorecard from sandbox artifacts only
...
def main() -> int:
    ...
    parser.add_argument(
        "--skip-latex",
        action="store_true",
        help="Compatibility flag; public package does not compile LaTeX docs.",
    )
    ...
    workbook_path = sb / "rmbs_model.xlsx"
    ...
    latex_rows: list[list[object]] = [["public_docs", "NOT_APPLICABLE", "No LaTeX docs in public package"]]
